package fpl.smartlib;


import fpl.smartlib.processor.BotCountStreamBuilder;
import fpl.smartlib.processor.EventCountTimeseriesBuilder;
import fpl.smartlib.processor.WebsiteCountStreamBuilder;
...
public class WikimediaStreamsApp {
    ...
    private static final String INPUT_TOPIC = "wikimedia.recentchange.connect";

    static {
        properties = new Properties();
        properties.put(StreamsConfig.APPLICATION_ID_CONFIG, "wikimedia-stats-application");
        properties.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "10.10.9.128:9092");
